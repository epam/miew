...
describe('ImmediateLoader', () => {
  ...
  describe('.canLoad()', () => {
    ...
    it('can\'t load undefined source', () => expect(ImmediateLoader.canLoad()).to.equal(false));

    it('can\'t load unknown source', () => expect(ImmediateLoader.canLoad('')).to.equal(false));

    it('can\'t load not "immediate" source', () => expect(ImmediateLoader.canLoad('', {})).to.equal(false));

    it('should load sourceType = \'immediate\'', () => expect(ImmediateLoader.canLoad('', correctOpts)).to.equal(true));
  });
