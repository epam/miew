...
;(function () {
  ...
  const liStile =
    'list-style-type: none; margin: 6px; text-align: center; padding: 10px; border-radius: 5px; color: #ffffff;'
  ...
  viewer.addEventListener('fetchingDone', () => {
    infoEventHandler(
      'Fetching finished',
      liStile + 'background-color:#59575a',
      5000
    )
  })
  ...
  viewer.addEventListener('repAdded', () => {
    infoEventHandler(
      'New rep added',
      liStile + 'background-color:#30575a',
      5000
    )
  })
