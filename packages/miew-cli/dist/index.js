...
Object.defineProperty(Logger.prototype, 'level', {
  get: function get() {
    var _this = this;
    return lodash.findKey(priorities, function (value) {
...
Logger.prototype._message = function (priority, message) {
  ...
  var level = lodash.findKey(priorities, function (value) {
...
function deriveClass(cls, base, members, statics) {
  cls.prototype = lodash.assign(Object.create(base.prototype), {
    constructor: cls
  }, members);
  if (statics) {
...
var selectors = miew.Miew.chem.selectors,
    modes = miew.Miew.modes,
    colorers = miew.Miew.colorers,
    materials = miew.Miew.materials,
    palettes = miew.Miew.palettes,
    options = miew.Miew.options,
    settings = miew.Miew.settings;
function None() {}
var NULL = function () {
  var obj = new None();
  return function () {
  ...
  _createClass(CLIUtils, [{
    ...
    value: function help$1(path) {
      if (lodash.isUndefined(path)) {
        return "".concat(this.joinHelpStr(help.$help), "\n").concat(lodash.slice(lodash.sortBy(lodash.keys(help)), 1).join(', '), "\n");
      }
      var helpItem = lodash.get(help, path);
      return lodash.isUndefined(helpItem) ? this.help() : "".concat(this.joinHelpStr(helpItem.$help), "\n");
    }
  }, {
    key: "load",
    ...
    value: function propagateProp(path, arg) {
      if (path !== undefined) {
        ...
        if (arg !== undefined && adapter(arg) !== arg && adapter(arg) !== arg > 0) {
          argExc = {
            message: "".concat(path, " must be a \"").concat(_typeof(lodash.get(settings.defaults, path)), "\"")
          };
          throw argExc;
        }
      }
...
exports["default"] = getMiewWithCli;
